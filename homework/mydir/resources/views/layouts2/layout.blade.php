...
<head>
    ...
    <!-- Google Web Fonts -->
    <link rel="preconnect" href="assets2/https://fonts.gstatic.com">
    <link href="assets2/https://fonts.googleapis.com/css2?family=Handlee&family=Nunito&display=swap" rel="stylesheet">

    <!-- Font Awesome -->
    <link href="assets2/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css" rel="stylesheet">

    <!-- Flaticon Font -->
    <link href="assets2/lib/flaticon/font/flaticon.css" rel="stylesheet">
...
<body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <img src="assets2/img/logo jp.png" width="90" height="90" alt="lorem">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                ...
                <a class="btn btn-primaryy px-4" href="Uzb"><img style="padding: 3px;" src="assets2/img/Uzbekistan-Flag-icon.png" width="35" height="35" alt="lorem"></a>
                <a class="btn btn-primaryy px-4" href="Uzb"><img style="padding: 3px;" src="assets2/img/united-states-of-america-flag-png-xl.png" width="35" height="35" alt="lorem"></a>
                <a class="btn btn-primaryy px-4" href="Uzb"><img style="padding: 3px;" src="assets2/img/Russia-flag.png" width="35" height="35" alt="lorem"></a>
    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <img class="img-fluid mt-5" src="assets2/img/header.png" alt="">
            </div>
        </div>
    </div>
    @yield('content')
    ...
    <div class="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
        ...
        <div class="container-fluid pt-5" style="border-top: 1px solid rgba(23, 162, 184, .2);;">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-primary font-weight-bold" href="assets2/index.html">Jajji Professor</a>. Barcha huquqlar himoyalangan.
                <a class="text-primary font-weight-bold" href="assets2/https://htmlcodex.com">IT RISE UP</a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
    ...
    <script src="assets2/https://code.jquery.com/jquery-3.4.1.min.js"></script>
    <script src="assets2/https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="assets2/mail/jqBootstrapValidation.min.js"></script>
    <script src="assets2/mail/contact.js"></script>
