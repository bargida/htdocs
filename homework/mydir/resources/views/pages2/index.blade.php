    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid rounded mb-5 mb-lg-0" src="assets2/img/about-1.jpg" alt="">
                </div>
                <div class="col-lg-7">
            ...
            <div class="row">
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="assets2/img/class-1.jpg" alt="">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="assets2/img/class-2.jpg" alt="">
                        <div class="card-body text-center">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card border-0 bg-light shadow-sm pb-2">
                        <img class="card-img-top mb-2" src="assets2/img/class-3.jpg" alt="">
                        <div class="card-body text-center">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3 text-center team mb-5">
                    <div class="position-relative overflow-hidden mb-4" style="border-radius: 100%;">
                        <img class="img-fluid w-100" src="assets2/img/team-1.jpg" alt="" >
                        <div
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="assets2/img/testimonial-1.jpg" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                ...
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="assets2/img/testimonial-2.jpg" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                ...
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="assets2/img/testimonial-3.jpg" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
                ...
                <div class="testimonial-item px-3">
                    ...
                    <div class="d-flex align-items-center">
                        <img class="rounded-circle" src="assets2/img/testimonial-4.jpg" style="width: 70px; height: 70px;" alt="Image">
                        <div class="pl-3">
            ...
            <div class="row pb-3">
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="assets2/img/blog-1.jpg" alt="">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="assets2/img/blog-2.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Maqola sarlavhasi</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Komiljanova Nargiza</small>
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0 shadow-sm mb-2">
                        <img class="card-img-top mb-2" src="assets2/mg/blog-3.jpg" alt="">
                        <div class="card-body bg-light text-center p-4">
                            <h4 class="">Maqola sarlavhasi</h4>
                            <div class="d-flex justify-content-center mb-3">
                                <small class="mr-3"><i class="fa fa-user text-primary"></i> Komiljanova Nargiza</small>
