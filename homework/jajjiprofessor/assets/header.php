        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    <a href="?page=header" class="nav-item nav-link active">Bosh sahifa</a>
                    <!-- <a href="about.html" class="nav-item nav-link">About</a> -->
                    <a href="?page=class" class="nav-item nav-link">Sinflar</a>
                    <a href="?page=teachers" class="nav-item nav-link">O'qituvchilar</a>
                    <a href="?page=home" class="nav-item nav-link ">Yutuqlar</a>
                    <a href="?page=home" class="nav-item nav-link">Galereya</a>
                    <a href="?page=articles" class="nav-item nav-link">Maqolalar</a>
                    <a href="?page=registration" class="nav-item nav-link">Aloqa</a>
                </div>
                </div> 
